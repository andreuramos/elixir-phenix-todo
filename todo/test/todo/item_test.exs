defmodule Todo.ItemTest do
    ...
    describe "items" do
        ...
        test "create_ite/1 with invalid data reurns error changeset" do
            assert {:error, %Ecto.Changeset{}} = Item.create_item(@invalid_attrs)
        end

        test "list_items/0 returns a list of todo items stored in DB" do
            item1 = item_fixture()
            item2 = item_fixture()
        ...
        test "update_item/2 with vlaid data updates the item" do
            item = item_fixture()
